Page({
  data: {
    ...
    pageImage: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/护肤品摆拍.png',
    readCount: 1276,
    ...
    serumTypes: [
      {
        ...
        imageUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/保湿型精华乳.png',
        videoUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/保湿型精华乳.mp4',
        recommendProducts: [
          { name: 'B5面霜', id: 201 },
          { name: '厚皮精华', id: 203 }
        ]
      },
      {
        ...
        imageUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/抗老紧致精华乳.png',
        videoUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/美白淡斑型精华乳.mp4',
        recommendProducts: [
          { name: '原白乳', id: 103 },
      ...
      },
      {
        ...
        imageUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/抗老紧致精华乳.png',
        videoUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/抗老紧致型精华乳.mp4',
        recommendProducts: [
          { name: '双A醇精华乳2.0', id: 1 },
          { name: '超A瓶精华', id: 5 }
        ]
      },
      {
        ...
        imageUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/舒缓维护型精华乳.png',
        videoUrl: 'cloud://YOUR_CLOUD_ENV_ID.636c-YOUR_CLOUD_ENV_ID-1333491872/如何选择适合的精华乳/舒缓修护型精华乳.mp4',
        recommendProducts: [
          { name: '闪修精华', id: 204 },
          { name: '弹簧霜2.0', id: 202 }
        ]
